...
class ValuesCardSettings extends FormattingSettingsCard {
    public blankValueLabel =
        new formattingSettings.TextInput({
            ...
            description:
                "Set the label generated by the visual for genuine null or empty hierarchy values. Source text such as '(Blank)' is not changed.",
            value: "(No value)",
...
class TooltipCardSettings extends FormattingSettingsCard {
    public hoverDelay =
        new formattingSettings.NumUpDown({
            ...
            description:
                "Set how long the pointer must remain over a value before its path tooltip appears. Format the tooltip font, colours, background and transparency under General > Tooltips.",
            value: 700,
            options: {
                minValue: {
                    type:
    ...
    public displayName: string = "Tooltips (style under General)";
